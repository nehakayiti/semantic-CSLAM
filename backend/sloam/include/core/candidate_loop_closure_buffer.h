...
namespace sloam {
    struct LoopClosureCandidate {
        ...
        //int targetPoseIdx = -1; // actually size_t // which pose node on the target robot is part of the loop closure
    ...
    struct AcceptedLoopClosure {
        ...
        //int targetPoseIdx = -1; // which pose node on the target robot is part of the loop closure
